...
this.state.student_list.splice(x,1)
      ...
      <div class="jumbotron">
        <h1>
          ...
          <div class="form-group">
            <label htmlFor="carnet" class="col-sm-2 col-form-label">Ingrese el carnet: </label>
            <input value={this.state.carnet} onChange={this.onChange.bind(this)}  class="form-control" type="text" name="carnet" id="carnet_field" />
          </div>

          <div class="form-group">
            <label for="schedule">Seleccione el horario:</label>
            <select value={this.state.schedule} onChange={this.onChange.bind(this)} name="schedule" class="form-control" id="schedule_field">
        ...
        <div class="form-group">
            <button onClick={this.save.bind(this)} type="button" class="btn btn-danger" id="submit_btn" enable>Ingresar</button>
        </div>
    </div>
    </div>
